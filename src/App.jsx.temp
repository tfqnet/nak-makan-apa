      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ color: '#4c1d95', marginTop: 0 }}>Support the Developer</h3>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
              <div style={{
                ...
                <h4 style={{ margin: '0 0 10px 0', color: '#4c1d95', fontSize: '16px' }}>PayPal</h4>
                <a 
              ...
              <div style={{
                ...
                <h4 style={{ margin: '0 0 10px 0', color: '#4c1d95', fontSize: '16px' }}>Touch 'n Go eWallet</h4>
                <p style={{ margin: '0 0 10px 0', fontSize: '14px', color: '#666' }}>
                  For Malaysian users - scan QR code or transfer to:
                </p>
                <div style={{
                  background: '#f9fafb',
                  border: '1px solid #e5e7eb',
